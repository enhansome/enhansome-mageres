...
* [Beginner's Guide to Contribution](https://github.com/magento/magento2/wiki/Getting-Started) ⭐ 12,170 | 🐛 2,145 | 🌐 PHP | 📅 2026-09-02 - All you have to know to start contributing to Magento.
* [Magento 2 code repository](https://github.com/magento/magento2) ⭐ 12,170 | 🐛 2,145 | 🌐 PHP | 📅 2026-09-02 - Official Magento 2 GitHub repository
...
* [Composer Patches](https://github.com/cweagans/composer-patches) ⭐ 1,725 | 🐛 56 | 🌐 PHP | 📅 2026-08-31 - Simple patches plugin for Composer - usage guide: <https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#custom-patches>
* [netz98 magerun CLI tools for Magento 2](https://github.com/netz98/n98-magerun2) ⭐ 925 | 🐛 19 | 🌐 PHP | 📅 2026-09-01 - The swiss army knife for Magento 2 developers
...
* [ElasticSuite for Magento 2](https://github.com/Smile-SA/elasticsuite) ⭐ 802 | 🐛 131 | 🌐 PHP | 📅 2026-08-28 - A feature-rich merchandising suite for Magento 2.
...
* [Magento 2 module for WebP](https://github.com/yireo/Yireo_Webp2) ⭐ 212 | 🐛 19 | 🌐 PHP | 📅 2026-08-31 - This extension adds WebP support to Magento 2.
...
* [Mailchimp for Magento 2](https://github.com/mailchimp/mc-magento2) ⭐ 160 | 🐛 12 | 🌐 PHP | 📅 2026-09-01 - The official Mailchimp for Magento 2 extension
...
* [Magento 2 module for Whoops](https://github.com/yireo/Yireo_Whoops) ⭐ 102 | 🐛 3 | 🌐 PHP | 📅 2026-09-01 - Magento 2 module integrating Whoops error handling.
...
* [Yireo ExtensionChecker](https://github.com/yireo/Yireo_ExtensionChecker) ⭐ 96 | 🐛 11 | 🌐 PHP | 📅 2026-09-01 - Magento 2 module to check upon the code of Magento 2 modules from the CLI
...
* [Yireo LinkPreload](https://github.com/yireo/Yireo_LinkPreload) ⭐ 92 | 🐛 5 | 🌐 PHP | 📅 2026-09-01 - Magento 2 extension to set HTTP Link headers for primary resources to allow for HTTP/2 Server Push
...
* [Structured Data Module for Magento 2](https://github.com/outeredge/magento-structured-data-module) ⭐ 77 | 🐛 4 | 🌐 PHP | 📅 2026-09-01 - This extension lets you quickly add structured data markup (Rich Snippets) to any Magento 2 store by setting a few configuration options.
...
* [EmailTester 2 by Yireo](https://github.com/yireo/Yireo_EmailTester2) ⭐ 34 | 🐛 7 | 🌐 PHP | 📅 2026-09-01 - Preview any transactional email in your Magento 2 backend.
...
* [Marketplace](https://github.com/swissup/module-marketplace) ⭐ 17 | 🐛 0 | 🌐 PHP | 📅 2026-09-02 - Magento modules and themes CLI/GUI downloader and installer
...
* [Magewire](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-01 - A Hyva Themes first Magento 2 extension to make it fun and easy to build modern, reactive and dynamic interfaces.
...
* [bitexpert/phpstan-magento](https://github.com/bitExpert/phpstan-magento) ⭐ 149 | 🐛 13 | 🌐 PHP | 📅 2026-08-31 - Magento specific extension for PHPStan
...
* [Magento 2 integration testing helper](https://github.com/yireo/Yireo_IntegrationTestHelper) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2026-09-01 - This module adds various utilities to aid in creating integration tests for Magento 2.
...
* [DDEV-Local](https://github.com/drud/ddev) ⭐ 3,830 | 🐛 162 | 🌐 Go | 📅 2026-09-02 - Open source tool that makes it simple to get local PHP development environments up and running in minutes, including Magento 1 and 2.
...
* [Madock](https://github.com/faradey/madock) ⭐ 41 | 🐛 1 | 🌐 Go | 📅 2026-09-02 - A local Docker-based PHP environment that supports Magento2 other than custom projects.

...
* [Beginner's Guide to Contribution](https://github.com/magento/magento2/wiki/Getting-Started) ⭐ 12,163 | 🐛 2,126 | 🌐 PHP | 📅 2026-08-12 - All you have to know to start contributing to Magento.
* [Magento 2 code repository](https://github.com/magento/magento2) ⭐ 12,163 | 🐛 2,126 | 🌐 PHP | 📅 2026-08-12 - Official Magento 2 GitHub repository
...
* [Magepack](https://github.com/magesuite/magepack) ⭐ 435 | 🐛 78 | 🌐 JavaScript | 📅 2023-12-29 - Easy-to-use tool for making Magento 2 frontend as fast as never before.
...
* [Magento Toolbox](https://github.com/magebitcom/magento-toolbox) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-04 - The Magento Toolbox extension aims to enhance Magento and Adobe Commerce development in VS Code compatible editors by providing code definitions, code generation, autocomplete, and other features.
...
* [Composer Patches](https://github.com/cweagans/composer-patches) ⭐ 1,716 | 🐛 56 | 🌐 PHP | 📅 2026-08-10 - Simple patches plugin for Composer - usage guide: <https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#custom-patches>
* [netz98 magerun CLI tools for Magento 2](https://github.com/netz98/n98-magerun2) ⭐ 927 | 🐛 21 | 🌐 PHP | 📅 2026-08-10 - The swiss army knife for Magento 2 developers
...
* [Magento Coding Standard](https://github.com/magento/magento-coding-standard) ⭐ 374 | 🐛 96 | 🌐 PHP | 📅 2026-03-06 - A set of Magento rules for PHP\_CodeSniffer tool.
...
* [Vaimo Composer Patches](https://github.com/vaimo/composer-patches) ⭐ 304 | 🐛 34 | 🌐 PHP | 📅 2026-08-08 - Applies a patch from a local or remote file to any package that is part of a given composer project. Example <https://gist.github.com/amenk/908e80748662d896718685c778cd4db4>
* [Magento 2 Code Generator Tool](https://github.com/staempfli/magento2-code-generator/) ⭐ 245 | 🐛 7 | 🌐 PHP | 📅 2021-04-07 - Code generator for Magento 2
...
* [GdprDump](https://github.com/Smile-SA/gdpr-dump) ⭐ 222 | 🐛 9 | 🌐 PHP | 📅 2026-02-24 - A tool that provides a command that creates anonymized dumps of a MySQL database, in order to comply with GDPR regulations.
...
* [ConvertM1M2](https://github.com/unirgy/convertm1m2) ⭐ 146 | 🐛 13 | 🌐 PHP | 📅 2018-10-24 - A script to automate as much as possible the conversion of a Magento 1 extension to Magento 2.
...
* [Laragento](https://github.com/Genaker/laragento) ⭐ 102 | 🐛 9 | 🌐 PHP | 📅 2026-02-13 - A collection of Model classes that allows you to get data directly from a Magento 2 database using Laravel’s Eloquent ORM.
...
* [NodeJento](https://github.com/Genaker/nodejento) ⭐ 85 | 🐛 2 | 🌐 JavaScript | 📅 2026-02-13 - NodeJS implementation of the Magento 2 ORM without using legacy PHP
...
* [Simple Import / Export tool](https://github.com/EcomDev/sync-magento-2-migration) ⭐ 59 | 🐛 0 | 🌐 PHP | 📅 2024-05-24 - A tool that allows to quickly export data from Magento 1 and Magento 2 store and import it back into Magento 2.
...
* [Magento 2 Model Generator](https://github.com/michielgerritsen/magento2-model-generator) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-11 - With this app, you can create models for Magento 2 very fast. Ready-to-use on <https://www.model-generator.com/>
...
* [PyGento](https://github.com/Genaker/PyGento) ⭐ 31 | 🐛 1 | 🌐 Python | 📅 2026-02-10 - A Python module to work with Magento Database directly without using native Magento 2 core
...
* [Magento 2 LSP](https://github.com/mage-os-lab/magento2-lsp) ⭐ 27 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-08 - Magento 2 tooling for editors and AI agents. The LSP Server works alongside Intelephense or Phpactor: it handles the Magento-specific connections that generic PHP tooling can't see. The MCP Server exposes the Magento 2 intelligence of the LSP server to AI coding agents.
* [Oh My ZSH Plugin - Magento 2](https://github.com/dambrogia/oh-my-zsh-plugin-magento-2) ⭐ 26 | 🐛 1 | 🌐 Shell | 📅 2022-08-23 - Magento 2 autocomplete plugin for oh-my-zsh
...
* [Mage](https://github.com/GrimLink/mage) ⭐ 25 | 🐛 3 | 🌐 Shell | 📅 2026-08-03 - This tool enhances Magento 2 development by providing shortcuts and custom functions for common bin/magento commands. It introduces shorter aliases, helper commands like reindex and purge, and features such as mage open to access store views quickly. Additionally, the watch command automates cache cleaning upon file changes, streamlining the development workflow.
* [Magento Toolbox](https://github.com/magebitcom/magento-toolbox) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-04 - A developer-focused extension for Visual Studio Code and Cursor, that offers a suite of tools for code generation, inspection, and utility functions, enhancing productivity and code quality.​
...
* [Magento Bricklayer](https://github.com/Inchoo/magento-bricklayer) ⭐ 19 | 🐛 0 | 🌐 PHP | 📅 2026-08-11 - An MCP server that provides AI coding agents with runtime visibility into Magento 2, enabling them to make informed architectural decisions rather than guessing.
...
* [mage-remote-run](https://github.com/muench-dev/mage-remote-run) ⭐ 8 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-11 - The remote swiss army knife for Magento Open Source, Mage-OS, Adobe Commerce.
...
* [Magento utilities Tap for Homebrew](https://github.com/fballiano/homebrew-mageutils) ⭐ 8 | 🐛 0 | 🌐 Ruby | 📅 2025-04-29
...
* [Magento Vulnerability Database](https://github.com/sansecio/magevulndb) ⭐ 220 | 🐛 10 | 🌐 PHP | 📅 2026-08-10 - List of Magento 1 and 2 integrations with known security issues
...
* [PolyShell Protection Module](https://github.com/aregowe/magento2-module-polyshell-protection) ⭐ 62 | 🐛 3 | 🌐 PHP | 📅 2026-08-04 - Comprehensive defense-in-depth module that closes the PolyShell unrestricted file upload vulnerability (APSB25-94) in Adobe Commerce. PolyShell affects all Magento Open Source and Adobe Commerce versions up to 2.4.9-alpha2. No official isolated patch exists for production versions.
...
* [ElasticSuite for Magento 2](https://github.com/Smile-SA/elasticsuite) ⭐ 803 | 🐛 126 | 🌐 PHP | 📅 2026-08-12 - A feature-rich merchandising suite for Magento 2.

* [Developer Toolbar by vpietri](https://github.com/vpietri/magento2-developer-quickdevbar) ⭐ 577 | 🐛 6 | 🌐 PHP | 📅 2026-05-19 - The structure of this toolbar is extremely simple you just need to add a new block in the layout to get your tab running.
...
* [Regenerate URL rewrites extension](https://github.com/olegkoval/magento2-regenerate_url_rewrites) ⭐ 444 | 🐛 16 | 🌐 PHP | 📅 2026-08-09 - This extension adds a CLI command that allows the regeneration of URL rewrites of products and categories in all stores or a specific store.
...
* [Magento 2 Menu](https://github.com/SnowdogApps/magento2-menu) ⭐ 331 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-11 - Provides powerful menu editor to replace category based menus in Magento 2.
...
* [Google Tag Manager with Advance Data Layer](https://github.com/magepal/magento2-google-tag-manager) ⭐ 265 | 🐛 15 | 🌐 PHP | 📅 2026-05-15 - The extension provides a vast array of over 60 preconfigure data layer elements to make integrating your Magento store with any other third-party service a breeze using Google Tag Manager.
...
* [Magento 2 module for WebP](https://github.com/yireo/Yireo_Webp2) ⭐ 212 | 🐛 18 | 🌐 PHP | 📅 2026-02-16 - This extension adds WebP support to Magento 2.
...
* [Magento 2 Sentry Logger](https://github.com/justbetter/magento2-sentry) ⭐ 187 | 🐛 12 | 🌐 PHP | 📅 2026-08-12 - This extension integrates the Sentry SDK into Magento 2 to directly send notifications and errors to Sentry.

* [Magento 2 Social Login Extension](https://github.com/mageplaza/magento-2-social-login) ⭐ 184 | 🐛 24 | 🌐 HTML | 📅 2026-08-13 - This extension allows quick login to a Magento store through Facebook, Google Plus, Twitter, and LinkedIn.

* [Magento 2 Configurator](https://github.com/ctidigital/magento2-configurator) ⭐ 174 | 🐛 22 | 🌐 PHP | 📅 2026-06-14 - A Magento module for creating and maintaining database variables from files. It allows you to share and collaborate on versioned configurations and split them by environment.
...
* [BitExpert\_ForceCustomerLogin](https://github.com/bitExpert/magento2-force-login) ⭐ 169 | 🐛 7 | 🌐 PHP | 📅 2024-05-01 - Magento 2 module that forces customer login to see website pages.

* [Yireo GoogleTagManager2](https://github.com/yireo/Yireo_GoogleTagManager2) ⭐ 168 | 🐛 29 | 🌐 PHP | 📅 2026-07-28 - Add Google Tag Manager to Magento2
...
* [ConfigImportExport](https://github.com/semaio/Magento2-ConfigImportExport) ⭐ 165 | 🐛 7 | 🌐 PHP | 📅 2026-05-29 - This extension provides CLI commands for Magento 2 to import/export system configuration data.
...
* [Product Data Pre-Loader](https://github.com/EcomDev/magento2-product-preloader) ⭐ 120 | 🐛 2 | 🌐 PHP | 📅 2023-02-07 - This extension provides an easy way to pre-load data for product collections like prices, stock data, and many more by using different types of load types.
...
* [Legacy Mysql Search](https://github.com/swissup/module-search-mysql-legacy) ⭐ 105 | 🐛 0 | 🌐 PHP | 📅 2026-02-26 - MySQL is no longer supported for search since Magento 2.4. This extension brings back the usage of the MySQL search engine on Magento 2.
...
* [Goomento Page Builder](https://github.com/Goomento/PageBuilder) ⭐ 104 | 🐛 1 | 🌐 PHP | 📅 2026-08-11 - A free Magento Page Builder extension that allows you to efficiently set up your website by simply dragging and dropping manipulation

* [Magento 2 module for Whoops](https://github.com/yireo/Yireo_Whoops) ⭐ 102 | 🐛 3 | 🌐 PHP | 📅 2026-06-01 - Magento 2 module integrating Whoops error handling.
...
* [Magento 2 Admin Activity](https://github.com/kiwicommerce/magento2-admin-activity) ⭐ 101 | 🐛 10 | 📅 2025-10-30 - This extension records activities such as adding, editing, deleting, printing, viewing, and mass updating entities like products, categories, and customers. Additionally, it tracks admin login attempts, including failed logins, capturing user information and IP addresses.

* [Magento 2 CORS](https://github.com/graycoreio/magento2-cors) ⭐ 101 | 🐛 1 | 🌐 PHP | 📅 2026-07-19 - Enables configurable CORS Headers on GraphQL and REST APIs

* [Akeneo Connector for Magento 2](https://github.com/akeneo/magento2-connector-community) ⭐ 96 | 🐛 175 | 🌐 PHP | 📅 2026-06-17 - A module that allows you to export your catalog data and structure from Akeneo PIM Community Edition to Magento 2 through API calls.
...
* [Yireo ExtensionChecker](https://github.com/yireo/Yireo_ExtensionChecker) ⭐ 96 | 🐛 11 | 🌐 PHP | 📅 2026-06-02 - Magento 2 module to check upon the code of Magento 2 modules from the CLI
...
* [Elgentos Large Config Products](https://github.com/elgentos/LargeConfigProducts) ⭐ 94 | 🐛 6 | 🌐 PHP | 📅 2023-04-14 - Workaround extension to work with extremely large configurable products (5000+ skus)
...
* [CheckoutTester module for Magento 2](https://github.com/yireo/Yireo_CheckoutTester2) ⭐ 93 | 🐛 3 | 🌐 PHP | 📅 2024-10-24 - A simple extension to preview the checkout success-page at any time.

* [Yireo LinkPreload](https://github.com/yireo/Yireo_LinkPreload) ⭐ 92 | 🐛 5 | 🌐 PHP | 📅 2026-05-19 - Magento 2 extension to set HTTP Link headers for primary resources to allow for HTTP/2 Server Push
...
* [Integer\_Net Session Unblocker](https://github.com/integer-net/magento2-session-unblocker) ⭐ 87 | 🐛 7 | 🌐 PHP | 📅 2025-01-07 - Module for Magento 2 that prevents session blocking between concurrent AJAX requests
...
* [Multi-Threading for Magento 2](https://github.com/zepgram/module-multi-threading) ⭐ 81 | 🐛 0 | 🌐 PHP | 📅 2026-02-08 - This extension allows processing large data collections in parallel using multiple child processes, improving performance and reducing processing time.
...
* [Structured Data Module for Magento 2](https://github.com/outeredge/magento-structured-data-module) ⭐ 77 | 🐛 6 | 🌐 PHP | 📅 2026-08-07 - This extension lets you quickly add structured data markup (Rich Snippets) to any Magento 2 store by setting a few configuration options.
...
* [Magento 2 Admin Order Status Color](https://github.com/mateussantin/magento2-admin-order-status-color) ⭐ 57 | 🐛 1 | 🌐 Less | 📅 2023-11-07 - An extension to change the color of the order status column in the UI grid, based on the current status of the order.
...
* [Breeze](https://github.com/breezefront/module-breeze) ⭐ 51 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-12 - A Magento 2 extension that replaces Luma's js stack with its own implementation.

* [Alekseon Widget Forms](https://github.com/Alekseon/magento2-widget-forms) ⭐ 50 | 🐛 0 | 🌐 PHP | 📅 2026-02-11 - The Alekseon Widget Forms extension for Magento 2 allows administrators to embed custom forms into CMS pages using widgets. It integrates seamlessly with the Alekseon Custom Forms Builder, enabling the display of forms created in the admin panel on the frontend. This extension supports various input types and is compatible with Hyvä Themes, enhancing flexibility in form presentation.
...
* [Magento 2 module for NextGenImages](https://github.com/yireo/Yireo_NextGenImages) ⭐ 47 | 🐛 10 | 🌐 PHP | 📅 2026-02-16 - Magento 2 module to add next-gen image support to Magento 2.
...
* [Magento 2 Data GridsJS
  ](https://github.com/Genaker/magento_gridjs) ⭐ 44 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-13 - A Magento 2 extension for GridJS and DataTable integration with Magento 2.
...
* [Elgentos Prismic.io](https://github.com/elgentos/magento2-prismicio) ⭐ 39 | 🐛 9 | 🌐 PHP | 📅 2026-08-06 - Extension to integrate headless CMS Prismic.io into Magento 2
...
* [Magenizr ResetUiBookmarks](https://github.com/magenizr/Magenizr_ResetUiBookmarks) ⭐ 38 | 🐛 0 | 🌐 PHP | 📅 2026-08-04 - Allows admin users to reset their own UI bookmarks such as state of filters, column positions and applied sorting
...
* [DevDashboard2](https://github.com/magento-hackathon/DevDashboard2) ⭐ 34 | 🐛 15 | 🌐 PHP | 📅 2026-08-11 - The DevDashboard2 project is a developer-focused dashboard for Magento 2, created during a Magento Hackathon. It provides a centralized interface to access and manage useful developer tools, logs, caches, indexes, and system information. Its goal is to streamline the developer experience by offering quick access to common Magento 2 backend functions in a user-friendly way.

* [EmailTester 2 by Yireo](https://github.com/yireo/Yireo_EmailTester2) ⭐ 34 | 🐛 7 | 🌐 PHP | 📅 2026-07-09 - Preview any transactional email in your Magento 2 backend.
...
* [Aimes Checkout Designs](https://github.com/robaimes/module-checkout-designs) ⭐ 33 | 🐛 1 | 🌐 PHP | 📅 2026-06-29 - This module provides the ability to change checkout page designs/layout per store and customer group
...
* [DisableLog2 for Magento 2](https://github.com/yireo/Yireo_DisableLog2) ⭐ 31 | 🐛 3 | 🌐 PHP | 📅 2023-05-04 - This module disables various log attempts of the Magento core, improving performance slightly.
...
* [Magento 2 Storyblok Integration](https://github.com/Media-Lounge/magento2-storyblok-integration) ⭐ 29 | 🐛 10 | 🌐 PHP | 📅 2025-06-16 - This extension allows to create content-rich pages that are easily editable using the Storyblok interface.
...
* [Yireo AutoFlushCache](https://github.com/yireo/Yireo_AutoFlushCache) ⭐ 28 | 🐛 1 | 🌐 PHP | 📅 2023-09-27 - Automatically flush the cache whenever you save something in the System Configuration.
...
* [CustomGento\_Cookiebot
  ](https://github.com/customgento/module-cookiebot-m2) ⭐ 26 | 🐛 2 | 🌐 PHP | 📅 2026-05-22 - A Magento 2 module that integrates Cookiebot into your store.
...
* [LiqPay Extension for Magento 2](https://github.com/mcspronko/liqpay-magento2) ⭐ 23 | 🐛 9 | 🌐 PHP | 📅 2024-05-15 - This extension adds LiqPay payment integration to Magento 2.
...
* [Orangecat B2B Suite](https://github.com/olivertar/m2_b2bsdk) ⭐ 23 | 🐛 1 | 📅 2026-06-08 - A comprehensive B2B suite providing company accounts, custom pricing, credit payments, purchase approvals, quick ordering, RMAs, sales reps, and customer-specific catalog, shipping, and payment rules.
...
* [Yireo HtmlHints](https://github.com/yireo/Yireo_HtmlHints) ⭐ 19 | 🐛 0 | 🌐 PHP | 📅 2026-02-12 - A simple Magento 2 module that adds HTML hints (HTML comments <!-- -->) to a page's HTML output, providing details about the rendered block or container.
...
* [Marketplace](https://github.com/swissup/module-marketplace) ⭐ 18 | 🐛 2 | 🌐 PHP | 📅 2026-07-28 - Magento modules and themes CLI/GUI downloader and installer
...
* [Yireo DumpCmsContent](https://github.com/yireo/Yireo_DumpCmsContent) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2026-05-15 - A Magento 2 module that adds a CLI bin/magento cms:dump to dump all CMS pages and CMS blocks to a folder var/cms-output.

* [Yireo ThemeOverrideChecker](https://github.com/yireo/Yireo_ThemeOverrideChecker) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2025-08-11 - Magento module to find all files of a given Magento theme (for example Magento/luma), compare the found files with the parent theme (and/or modules) and return whether there are differences or not.
...
* [Magento 2 - Crawler Session](https://github.com/friends-of-hyva/magento2-crawler-session) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2024-04-09 - This module prevents the initiation of a session if a crawler is detected. Detection based on <https://github.com/JayBizzle/Crawler-Detect> ⭐ 2,394 | 🐛 0 | 🌐 PHP | 📅 2026-07-30.
...
* [Yireo ThemeCommands](https://github.com/yireo/Yireo_ThemeCommands) ⭐ 13 | 🐛 0 | 🌐 PHP | 📅 2026-08-11 - CLI commands to manage themes from the command-line
...
* [Magento 2 Product Data Sync](https://github.com/falconmedia/magento2-product-data-sync) ⭐ 11 | 🐛 0 | 🌐 PHP | 📅 2026-01-27 - A module for safely synchronising product data between products with support for multi-store configurations, attribute filtering, and comprehensive logging.
...
* [Mollie for Magento 2](https://github.com/mollie/magento2-hyva-checkout) ⭐ 11 | 🐛 1 | 🌐 HTML | 📅 2026-07-09 - The Mollie Magento 2 extension quickly integrates all major payment methods ready-made into your Magento webshop.
...
* [Magento 2 GraphQL Introspection Cache](https://github.com/graycoreio/magento2-graphql-introspection-cache) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-07-22 - This module allows you to use the same mechanism that is used for caching regular GraphQL resolvers, for introspection queries. This helps minimize the number of times Magento is bootstrapped.
...
* [Yireo AdditionalBlockTemplate](https://github.com/yireo/Yireo_AdditionalBlockTemplate) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2026-01-16 - A Magento 2 module to allow for additional templates to be rendered, besides the original template.
...
* [DisableServiceWorkerInAdmin for Magento 2](https://github.com/yireo/Yireo_DisableServiceWorkerInAdmin) ⭐ 7 | 🐛 1 | 🌐 HTML | 📅 2022-10-21 - Module used to unregister any ServiceWorkers when entering the backend.
...
* [Yireo DevHacks](https://github.com/yireo/Yireo_DevHacks) ⭐ 7 | 🐛 1 | 🌐 PHP | 📅 2026-04-10 - Magento 2 module with various hacks and solutions for custom development

* [Yireo’s Common ViewModels](https://github.com/yireo/Yireo_CommonViewModels) ⭐ 7 | 🐛 1 | 🌐 PHP | 📅 2023-04-15 - Common ViewModels for usage in Magento 2.2.1+ frontends.

* [BuilderIO Integration for Magento 2](https://github.com/DeployEcommerce/module-builderio) ⭐ 6 | 🐛 4 | 🌐 PHP | 📅 2026-03-12 - A Magento 2 extension that integrates Builder.io into your Magento store, enabling you to manage CMS pages and category headings effortlessly with Builder.io's visual editor. It is compatible with Hyvä Themes without requiring additional compatibility modules.
...
* [Yireo - Magento 2 Category Extended
  ](https://github.com/yireo/Yireo_CategoryExtended) ⭐ 5 | 🐛 0 | 🌐 PHP | 📅 2024-03-19 - This module seamlessly integrates CMS pages and custom URLs into your Magento 2 category structure, allowing you to create a more versatile and informative menu for your customers.
...
* [Magento 2 Tweakwise](https://github.com/EmicoEcommerce/Magento2Tweakwise) ⭐ 4 | 🐛 17 | 🌐 PHP | 📅 2026-08-12 - Magento 2 module for Tweakwise integration
...
* [Ideal-Postcodes UK Address Search and Validation](https://github.com/ideal-postcodes/magento) ⭐ 2 | 🐛 25 | 🌐 HTML | 📅 2026-06-10 - This extension enables Ideal-Postcodes.co.uk address validation for UK addresses on a Magento store.
...
* [Yireo Tablerate Commands](https://github.com/yireo/Yireo_TablerateCommands) ⭐ 2 | 🐛 0 | 🌐 PHP | 📅 2026-05-15 - A Magento 2 module offering CLI commands to manipulate table rates.
...
* [Yireo StoreView Commands](https://github.com/yireo/Yireo_StoreViewCommands) ⭐ 0 | 🐛 0 | 🌐 PHP | 📅 2026-05-15 - This extension adds a couple of CLI commands for managing (create or update) Store Views.
...
* [Magewire](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-10 - A Hyva Themes first Magento 2 extension to make it fun and easy to build modern, reactive and dynamic interfaces.
* [Hyvä Admin](https://github.com/hyva-themes/magento2-hyva-admin) ⭐ 178 | 🐛 34 | 🌐 CSS | 📅 2026-06-26 - This module aims to make creating grids and forms in the Magento 2 adminhtml area joyful and fast, without usage of UI components.
...
* [Hyvä Algolia Search](https://github.com/blackbird-agency/hyva-algolia-search) ⭐ 14 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-28 - This extension integrates Algolia’s powerful search capabilities into Magento 2 stores using the Hyvä frontend.
...
* [Hyvä Checkout support for Mollie](https://github.com/mollie/magento2-hyva-checkout) ⭐ 11 | 🐛 1 | 🌐 HTML | 📅 2026-07-09 - This module adds support for the Mollie payment methods to the Hyvä Checkout module. This module has a dependency on the Mollie Magento 2 module.
...
* [Tweakwise Hyvä](https://github.com/EmicoEcommerce/Magento2TweakwiseHyva) ⭐ 4 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-05 - Hyvä Themes Compatibility module for Magento 2 Tweakwise extension
...
* [Catalog Data AI](https://github.com/mage-os-lab/module-catalog-data-ai) ⭐ 39 | 🐛 13 | 🌐 PHP | 📅 2026-04-19 - Generate product descriptions and similar content with the help of AI.
...
* [Mage-OS PageBuilder Widget ](https://github.com/mage-os-lab/module-page-builder-widget) ⭐ 29 | 🐛 2 | 🌐 HTML | 📅 2026-08-10 - A Mage-OS extension that introduces a new PageBuilder component to allow inserting and configuring existing CMS widgets directly within the Page Builder.
...
* [MageOS Blog](https://github.com/mage-os-lab/module-blog) ⭐ 15 | 🐛 1 | 🌐 PHP | 📅 2026-08-12 - A blog module for Mage-OS and Magento 2. Posts, categories, tags, authors, scheduled publishing, RSS, sitemap, 6 storefront widgets, SEO (meta tags, Open Graph, Twitter Cards, JSON-LD), and a full GraphQL API. Works with Luma and Hyvä themes.
...
* [MageOS Newsletter Coupon Generator](https://github.com/mage-os-lab/module-newsletter-coupon) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2026-05-19 - Allows you to generate a unique coupon for each newsletter subscriber. The coupon will be sent to the subscriber’s email after the subscription.
...
* [Elgentos Magento 2 Cypress Testing Suite](https://github.com/elgentos/magento2-cypress-testing-suite) ⭐ 171 | 🐛 19 | 🌐 JavaScript | 📅 2024-03-28 - A community-driven Cypress testing suite for Magento 2.
* [bitexpert/phpstan-magento](https://github.com/bitExpert/phpstan-magento) ⭐ 148 | 🐛 10 | 🌐 PHP | 📅 2026-06-28 - Magento specific extension for PHPStan
* [GitHub Actions for Magento 2 Extensions](https://github.com/extdn/github-actions-m2) ⭐ 141 | 🐛 20 | 🌐 Shell | 📅 2026-08-11 - A repository that provides a set of open-sourced GitHub actions to write better tested Magento 2 extensions.
...
* [Magento 2 GitHub Actions](https://github.com/graycoreio/github-actions-magento2) ⭐ 72 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-10 - Opinionated Github Actions and Workflows to make building, testing, and maintaining Magento 2 Modules easier.
* [Elgentos Magento 2 Playwright](https://github.com/elgentos/magento2-playwright) ⭐ 47 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-04 - An open-source End-to-End testing suite built with Playwright to facilitate comprehensive testing of Magento storefronts, enhancing code reliability and reducing manual testing efforts.
...
* [Magento 2 Docker images for extension testing](https://github.com/michielgerritsen/magento2-extension-integration-test) ⭐ 38 | 🐛 0 | 🌐 PHP | 📅 2026-08-07 - Docker images that can be used to run Magento unit/integration/browser tests for your Magento 2 extensions.
* [Magento 2 in-a-box](https://github.com/michielgerritsen/magento2-extension-integration-test) ⭐ 38 | 🐛 0 | 🌐 PHP | 📅 2026-08-07 - Provides a streamlined environment for setting up and running unit, integration, and browser tests for Magento 2 extensions. Run a Docker container with the appropriate image tag (e.g., php83-fpm-magento2.4.7-p4) and immediately run tests, execute bin/magento commands, or access the Magento installation in a browser.
* [Magento 2 Hyvä playwright tests](https://github.com/ProxiBlue/m2-hyva-playwright) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - The goal of this project is to create an extensible Playwright testing environment for Magento 2 + Hyvä projects.
...
* [Magento 2 integration testing helper](https://github.com/yireo/Yireo_IntegrationTestHelper) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2026-06-13 - This module adds various utilities to aid in creating integration tests for Magento 2.
...
* [ParallelTestsPlus](https://github.com/CleatSquad/module-parallel-tests-plus) ⭐ 4 | 🐛 1 | 🌐 PHP | 📅 2025-12-01 - This extension enhances the core bin/magento dev:tests:run command so you can run Magento static, unit, integration, and integrity tests in parallel using ParaTest, reducing test execution time.
...
* [Yireo GraphQlRateLimiting](https://github.com/yireo/Yireo_GraphQlRateLimiting) ⭐ 14 | 🐛 3 | 🌐 PHP | 📅 2024-04-12 - Magento 2 module to add rate limiting to GraphQL resources.
* [Additional GraphQL endpoints for Magento 2](https://github.com/yireo/Yireo_AdditionalEndpointsGraphQl) ⭐ 11 | 🐛 1 | 🌐 PHP | 📅 2023-03-09 - Additional endpoints for loading information through GraphQL.
* [Yireo SyncGraphQlSessionWithFrontend](https://github.com/yireo/Yireo_SyncGraphQlSessionWithFrontend) ⭐ 11 | 🐛 1 | 🌐 PHP | 📅 2022-10-21 - Magento 2 module to sync a GraphQL session with the regular session.
* [Yireo CustomGraphQlQueryLimiter](https://github.com/yireo/Yireo_CustomGraphQlQueryLimiter) ⭐ 5 | 🐛 0 | 🌐 PHP | 📅 2025-08-14 - Magento 2 module to enhance performance and security of your headless Magento.
...
* [Deployer recipe for Magento 2](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 11,094 | 🐛 15 | 🌐 PHP | 📅 2026-07-13 - Michał Giza’s Deployer recipe for Magento 2.
...
* [DDEV-Local](https://github.com/drud/ddev) ⭐ 3,735 | 🐛 164 | 🌐 Go | 📅 2026-08-13 - Open source tool that makes it simple to get local PHP development environments up and running in minutes, including Magento 1 and 2.
* [Mark Shust's Docker Configuration for Magento](https://github.com/markshust/docker-magento) ⭐ 2,859 | 🐛 1 | 🌐 Shell | 📅 2026-07-30 - Magento 1 & 2 support on Linux and Mac
...
* [Docker Configuration for Magento 2](https://github.com/magenx/Magento-2-docker-configuration) ⭐ 42 | 🐛 4 | 🌐 Dockerfile | 📅 2026-08-09
* [Madock](https://github.com/faradey/madock) ⭐ 42 | 🐛 1 | 🌐 Go | 📅 2026-08-09 - A local Docker-based PHP environment that supports Magento2 other than custom projects.
...
* [Magenx e-commerce webstack](https://github.com/magenx/Magento-2-server-installation) ⭐ 211 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - This Magento 2 Open Source web stack promises a fully pre-configured server with Magento and LEMP stack in just 10 minutes! 
...
* [Magento 2 Devcontainer](https://github.com/graycoreio/magento2-devcontainer) ⭐ 18 | 🐛 4 | 🌐 Shell | 📅 2026-08-04 - Run Magento 2 locally with VS Code or instantly in GitHub Codespaces
...
* [Vagrant Magento 2 Fast VM](https://github.com/zepgram/magento2-fast-vm) ⭐ 105 | 🐛 2 | 🌐 Shell | 📅 2023-03-27 - Developer box for Magento2: supporting Linux, Windows and Mac. Also providing full support for PHP version compatible with Magento2

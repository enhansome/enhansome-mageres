...
* [Beginner's Guide to Contribution](https://github.com/magento/magento2/wiki/Getting-Started) ⭐ 12,195 | 🐛 2,187 | 🌐 PHP | 📅 2026-09-15 - All you have to know to start contributing to Magento.
* [Magento 2 code repository](https://github.com/magento/magento2) ⭐ 12,195 | 🐛 2,187 | 🌐 PHP | 📅 2026-09-15 - Official Magento 2 GitHub repository
...
* [Awesome Magento 2](https://github.com/run-as-root/awesome-magento2/) ⭐ 1,175 | 🐛 10 | 🌐 PHP | 📅 2026-09-14 - A curated list of awesome Magento 2 Extensions & Resources by David Lambauer
...
* [netz98 magerun CLI tools for Magento 2](https://github.com/netz98/n98-magerun2) ⭐ 925 | 🐛 21 | 🌐 PHP | 📅 2026-09-16 - The swiss army knife for Magento 2 developers
...
* [Vaimo Composer Patches](https://github.com/vaimo/composer-patches) ⭐ 304 | 🐛 39 | 🌐 PHP | 📅 2026-09-16 - Applies a patch from a local or remote file to any package that is part of a given composer project. Example <https://gist.github.com/amenk/908e80748662d896718685c778cd4db4>
...
* [Magento 2 Model Generator](https://github.com/michielgerritsen/magento2-model-generator) ⭐ 35 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - With this app, you can create models for Magento 2 very fast. Ready-to-use on <https://www.model-generator.com/>
...
* [fast-di-compile (Rust Magento DI Compiler)](https://github.com/speedupmate/di-compiler) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - A faster DI compiler written in Rust that should bring a 10x performance improvement.
...
* [Magento Vulnerability Database](https://github.com/sansecio/magevulndb) ⭐ 221 | 🐛 11 | 🌐 PHP | 📅 2026-09-17 - List of Magento 1 and 2 integrations with known security issues
...
* [ElasticSuite for Magento 2](https://github.com/Smile-SA/elasticsuite) ⭐ 802 | 🐛 133 | 🌐 PHP | 📅 2026-09-03 - A feature-rich merchandising suite for Magento 2.
...
* [Yireo GoogleTagManager2](https://github.com/yireo/Yireo_GoogleTagManager2) ⭐ 168 | 🐛 30 | 🌐 PHP | 📅 2026-09-17 - Add Google Tag Manager to Magento2
...
* [Magento Cloudflare Turnstile](https://github.com/Pixel-Open/magento-cloudflare-turnstile) ⭐ 57 | 🐛 7 | 🌐 PHP | 📅 2026-01-09 - The module allows Turnstile (Cloudflare's smart CAPTCHA alternative) to protect your Magento OpenSource or Adobe Commerce forms.
...
* [Custom Product Relation Sample Extension](https://github.com/magepal/magento2-link-product) ⭐ 55 | 🐛 2 | 🌐 PHP | 📅 2025-04-16 - This extension creates a new product accessory relationship in addition to the default ones.
...
* [Elgentos Remove Duplicate Product images in Magento 2](https://github.com/elgentos/magento2-product-duplicate-images-remove) ⭐ 21 | 🐛 0 | 🌐 PHP | 📅 2024-08-08 - This extension allows you to find duplicate product images from your product list and easily remove them by running a command.
...
* [IMI FriendlyCaptcha](https://github.com/iMi-digital/magento2-friendly-captcha) ⭐ 19 | 🐛 11 | 🌐 PHP | 📅 2026-06-17 - This extension adds a Friendly Captcha widget to Login, Register, Contact form, Forgot password, Send to Friend, Newsletter signup, Product Reviews.
...
* [Authorize.net's Customer Information Manager for Magento 2](https://github.com/ParadoxLabs-Inc/authnetcim) ⭐ 14 | 🐛 1 | 🌐 PHP | 📅 2026-09-16
* [Authorize.net CIM for Magento 2](https://github.com/ParadoxLabs-Inc/authnetcim) ⭐ 14 | 🐛 1 | 🌐 PHP | 📅 2026-09-16 - This extension brings Authorize.net's Customer Information Manager (CIM) service to Magento 2.
...
* [ShipperHQ Shipping Tracker](https://github.com/shipperhq/module-shipping-tracker) ⭐ 12 | 🐛 0 | 🌐 PHP | 📅 2026-09-16 - This extension allows you to enter custom shipment tracking URLs. Customers will see a clickable shipping tracking link in the new shipment email and when viewing their order in Magento.
...
* [CyberSource for Magento 2](https://github.com/ParadoxLabs-Inc/cybersource) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2026-09-16 - This extension brings CyberSource’s enterprise payment services to Magento 2.
...
* [Magewire](https://github.com/magewirephp/magewire) ⭐ 264 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-17 - A Hyva Themes first Magento 2 extension to make it fun and easy to build modern, reactive and dynamic interfaces.
...
* [Monsoon PWA](https://github.com/monsoonconsulting/magento2-pwa) ⭐ 24 | 🐛 5 | 🌐 PHP | 📅 2023-04-17 - Adds icons, a web manifest file and a service-worker file to make magento 2 a PWA.
...
* [DDEV-Local](https://github.com/drud/ddev) ⭐ 3,884 | 🐛 172 | 🌐 Go | 📅 2026-09-17 - Open source tool that makes it simple to get local PHP development environments up and running in minutes, including Magento 1 and 2.
...
* [Madock](https://github.com/faradey/madock) ⭐ 42 | 🐛 1 | 🌐 Go | 📅 2026-09-16 - A local Docker-based PHP environment that supports Magento2 other than custom projects.

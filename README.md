...
* [Beginner's Guide to Contribution](https://github.com/magento/magento2/wiki/Getting-Started) ⭐ 12,198 | 🐛 2,191 | 🌐 PHP | 📅 2026-09-17 - All you have to know to start contributing to Magento.
* [Magento 2 code repository](https://github.com/magento/magento2) ⭐ 12,198 | 🐛 2,191 | 🌐 PHP | 📅 2026-09-17 - Official Magento 2 GitHub repository
...
* [Awesome Magento 2](https://github.com/run-as-root/awesome-magento2/) ⭐ 1,174 | 🐛 5 | 🌐 PHP | 📅 2026-09-18 - A curated list of awesome Magento 2 Extensions & Resources by David Lambauer
...
* [netz98 magerun CLI tools for Magento 2](https://github.com/netz98/n98-magerun2) ⭐ 925 | 🐛 17 | 🌐 PHP | 📅 2026-09-17 - The swiss army knife for Magento 2 developers
...
* [PhpStorm Magento 2 Plugin](https://github.com/magento/magento2-phpstorm-plugin) ⭐ 463 | 🐛 62 | 🌐 Java | 📅 2026-09-07 - Magento PhpStorm plugin, created to improve life-work balance while working with Magento 2
...
* [Magento 2 Model Generator](https://github.com/michielgerritsen/magento2-model-generator) ⭐ 35 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 - With this app, you can create models for Magento 2 very fast. Ready-to-use on <https://www.model-generator.com/>
...
* [Magento Bricklayer](https://github.com/Inchoo/magento-bricklayer) ⭐ 29 | 🐛 0 | 🌐 PHP | 📅 2026-08-21 - An MCP server that provides AI coding agents with runtime visibility into Magento 2, enabling them to make informed architectural decisions rather than guessing.
...
* [Magento Vulnerability Database](https://github.com/sansecio/magevulndb) ⭐ 221 | 🐛 12 | 🌐 PHP | 📅 2026-09-17 - List of Magento 1 and 2 integrations with known security issues
...
* [ElasticSuite for Magento 2](https://github.com/Smile-SA/elasticsuite) ⭐ 803 | 🐛 133 | 🌐 PHP | 📅 2026-09-03 - A feature-rich merchandising suite for Magento 2.
...
* [Magento 2 Menu](https://github.com/SnowdogApps/magento2-menu) ⭐ 331 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-15 - Provides powerful menu editor to replace category based menus in Magento 2.
...
* [Yireo GoogleTagManager2](https://github.com/yireo/Yireo_GoogleTagManager2) ⭐ 168 | 🐛 30 | 🌐 PHP | 📅 2026-09-18 - Add Google Tag Manager to Magento2
...
* [Magento 2 MageAI Extension](https://github.com/mageprince/magento2-mage-ai) ⭐ 28 | 🐛 1 | 🌐 PHP | 📅 2026-09-18 - Magento 2 extension to generate product short/long descriptions and product images with OpenAI (ChatGPT), Anthropic (Claude) & Google Gemini. Customizable prompts, multiple models, and clean HTML output.
...
* [Siteation\_DebugBar](https://github.com/Siteation/magento2-debugbar) ⭐ 28 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-12 - A debug bar for Magento 2 built for developers and coding agents.
...
* [ShipperHQ Shipping Tracker](https://github.com/shipperhq/module-shipping-tracker) ⭐ 12 | 🐛 0 | 🌐 PHP | 📅 2026-09-18 - This extension allows you to enter custom shipment tracking URLs. Customers will see a clickable shipping tracking link in the new shipment email and when viewing their order in Magento.
...
* [Ai Dashboard](https://github.com/gabrielgts/module-ai-dashboard) ⭐ 11 | 🐛 0 | 🌐 PHP | 📅 2026-04-25 - AI-powered analytics dashboard for Magento 2. Replaces the stock admin dashboard with KPI cards, charts, and an embedded store assistant. All built from data computed on cron and served from cache.
...
* [Mollie for Magento 2](https://github.com/mollie/magento2-hyva-checkout) ⭐ 11 | 🐛 0 | 🌐 HTML | 📅 2026-09-17 - The Mollie Magento 2 extension quickly integrates all major payment methods ready-made into your Magento webshop.
...
* [Magento 2 Tweakwise](https://github.com/EmicoEcommerce/Magento2Tweakwise) ⭐ 4 | 🐛 9 | 🌐 PHP | 📅 2026-09-17 - Magento 2 module for Tweakwise integration
...
* [DDEV-Local](https://github.com/drud/ddev) ⭐ 3,888 | 🐛 174 | 🌐 Go | 📅 2026-09-18 - Open source tool that makes it simple to get local PHP development environments up and running in minutes, including Magento 1 and 2.
...
* [Colin Tickle’s Docker Stack](https://github.com/cmtickle/docker-stack) ⭐ 14 | 🐛 5 | 🌐 Shell | 📅 2025-10-28 - A dockerized system to run LEMP stack applications primarily developed to run Magento 2.
...
* [Vagrant for Magento 2 CE](https://github.com/paliarush/magento2-vagrant-for-developers) ⭐ 439 | 🐛 50 | 🌐 Shell | 📅 2019-06-17 - Vagrant project for Magento 2 developers (optimized for Mac, Windows and \*nix hosts)
